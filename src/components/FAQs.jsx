...
const FAQs = () => {
  const faqs = [
    {
      key: 1,
      label: <h4 className="font-sen text-lg font-semibold">What makes Authentic Ghana Tours unique?</h4>,
      children: <p className="font-quicksand">Authentic Ghana Tours is committed to providing authentic and immersive travel experiences.
    ...
    {
      key: 2,
      label: "How do I book a tour with Authentic Ghana Tours?",
    ...
    {
      key: 3,
      label: "What types of tours does Authentic Ghana Tours offer?",
    ...
    {
      key: 4,
      label: "Is it safe to travel with Authentic Ghana Tours?",
    ...
    {
      key: 5,
      label: "How can I get in touch with Authentic Ghana Tours for support during my trip?",
